...
void redirect_to_login()
{
	try
	{
		...
		cout << script() << endl;
		cout << "alert(\"Congratulations!!. You have been registered successfully!!\");" << endl;
		cout << script() << endl;
...
/*  The register_user Function
    This saves the username, password, email, and fullname the users to the database.
...
*/
void register_user(string username, string password, string email, string full_name)
{
	...
	try
	{
		...
		// add admin details to the login and admin_credentials database table.
		if(username == "admin")
		{
			...
			prep_stmt = con -> prepareStatement ("INSERT INTO admin_credentials (admin_id, name, username) VALUES (?,?,?)");
		...
		// add ordinary users details to the login and ordinary_users database table.
		else
		{
			// add 'ordinary users' details to the login database.
			prep_stmt = con -> prepareStatement ("INSERT INTO login (online,password,email,fullname,username) VALUES (?,?,?,?,?)");
			...
			prep_stmt = con -> prepareStatement ("INSERT INTO ordinary_users (name, username) VALUES (?,?)");
...
/*  The main Funcion
    ...
    It receives the user's input: username, password, email, and full name.
    It then calls the register_user function to register the users based on their details provided.
*/
int main()
{	
	string username = "";
